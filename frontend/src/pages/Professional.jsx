  ...
  return (
    <div className="booking-container fade-up">
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <img src="/logobelleza.jpg" alt="Mariana Farias" style={{ width: '120px', height: '120px', borderRadius: '50%', objectFit: 'cover', boxShadow: '0 4px 16px rgba(0,0,0,0.08)', border: '3px solid white', marginBottom: '1rem' }} />
